...
//	private final static Pattern END_NO_EXTENSION = Pattern.compile(".*(\\.(html|doc|pdf|gif|jpe?g|png|bmp|tiff?))$");
	...
	public static List<URLFetchNYTimes> fetchUrlList = new ArrayList<URLFetchNYTimes>();
	public static List<DownloadFileNYTimes> downloadFileList = new ArrayList<DownloadFileNYTimes>();
	public static List<DiscoveredURLNYTimes> visitUrlList = new ArrayList<DiscoveredURLNYTimes>();
	...
	protected void handlePageStatusCode(WebURL webUrl, int statusCode, String statusDescription) {
		fetchUrlList.add(new URLFetchNYTimes(webUrl.getURL().toLowerCase().replace(",", "_"), statusCode));
	...
	*/
	...
	public boolean shouldVisit(Page referringPage, WebURL url) {
	    ...
	    if (href.startsWith("https://www.nytimes.com/")  
     		   || href.startsWith("https://nytimes.com/") || href.startsWith("http://nytimes.com/") || href.startsWith("http://www.nytimes.com/") ) {
	    		visitUrlList.add(new DiscoveredURLNYTimes(href.replace(",", "_"), "OK"));
	    		if (!visitUrlSet.contains(href.replace(",", "_"))) {
	    			unique_url_within++;
	    		}
	    } else {
		    	visitUrlList.add(new DiscoveredURLNYTimes(href.replace(",", "_"), "N_OK"));
		    	if (!visitUrlSet.contains(href.replace(",", "_"))) {
	    			unique_url_outside++;
	    		}
	    }
...
//	    		return true;
//	    }
	    return href.startsWith("https://www.nytimes.com/") || href.startsWith("https://nytimes.com/") || href.startsWith("http://nytimes.com/")
...
//	    fetchUrlList.add(new URLFetchNYTimes(url.replace(",", "_"), httpStatusCode));
	    ...
	    downloadFileList.add(new DownloadFileNYTimes(url.replace(",", "_"), fileSizeKB, numOfOutlink, contentType));
